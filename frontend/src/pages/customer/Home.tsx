        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:grid grid-cols-2 gap-3">
            {[
              ...
              { src: "https://images.unsplash.com/photo-1550985616-10810253b84d?w=300&h=200&fit=crop&auto=format", alt: "LED Lighting" },
              ...
              <div key={img.alt} className="rounded-lg overflow-hidden bg-white/10">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1550985616-10810253b84d?w=300&h=200&fit=crop&auto=format";
                  }}
                />
              </div>
            ))}
